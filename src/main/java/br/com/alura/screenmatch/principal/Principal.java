...
public class Principal {
    ...
    private List<DadosSerie> dadosSeries = new ArrayList<>(); // Lista de séries
    ...
    private void buscarSerieWeb() {
        ...
        repositorio.save(serie); // injeção de dependência
    ...
    private void listarSeriesBuscadas() {
        series = repositorio.findAll(); // busca o que está cadastrado no repositório
        series.stream()
    ...
    private void buscarEpisodioPorTrecho() {
        System.out.println("Qual o trecho do nome do episódio para busca? ");
    ...
    private void buscarTop5EpisodiosPorSerie(){
        ...
        if(serieBusca.isPresent()){
            ...
            List<Episodio> topEpisodios = repositorio.toEpisodiosPorSerie(serie);
